const ssScenarios = [
  ...
  },
  {
    ...
    isSecure: false,
    explanation:
      "Her claimer de å selge Jordans fra Nike Factory Store, men URL-en forteller oss at dette ikke er ekte. Prisen er også for god til å være sann. ikke bli lurt!",
  },
  {
    img: "Bilder/pay-pail.png",
    isSecure: false,
    explanation:
      "Klassisk phishing. Se på URL-en. Det står pay-pail istedet for PayPal.",
  },
  {
    img: "Bilder/NTNU.png",
    isSecure: true,
    explanation:
      "En legit og offisiell NTNU side. Legg merke til den sikre tilkoblingen (https) og den korrekte domenenavnet (ntnu.no). Manglene CSS har ingenting å si.",
  },
];
...
function ssChoose(answer) {
  document.querySelectorAll(".ss-buttons button").forEach((button) => {
